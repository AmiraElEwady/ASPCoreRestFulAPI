...
namespace OnlineProducts.API.Controllers
{
    [ApiController]
    [Route("products")]
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public ActionResult<ProductsDto> PostProduct(ProductsCreateDto productsCreateDto)
        {
            ...
            var product = _mapper.Map<API.Entities.Product>(productsCreateDto);
        ...
        public IActionResult UpdateProduct(Guid productId, ProductUpdateDto productUpdateDto)
        {
            ...
            if (ProductRepo == null)
            {
                var productAdd = _mapper.Map<API.Entities.Product>(productUpdateDto);
